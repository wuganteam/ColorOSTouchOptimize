...
[![Release](https://img.shields.io/github/v/release/WuGanTeam/ColorOSTouchOptimize)](https://github.com/WuGanTeam/ColorOSTouchOptimize/releases)
[![Stars](https://img.shields.io/github/stars/WuGanTeam/ColorOSTouchOptimize)](https://github.com/WuGanTeam/ColorOSTouchOptimize)
...
| `stop_horae` | 是否停止 ColorOS 采样率管家（1=开 0=关） | 0 |
